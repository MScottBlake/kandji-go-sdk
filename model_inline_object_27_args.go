...
// checks if the InlineObject27Args type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &InlineObject27Args{}

// InlineObject27Args struct for InlineObject27Args
type InlineObject27Args struct {
...
type _InlineObject27Args InlineObject27Args
...
func (o InlineObject27Args) MarshalJSON() ([]byte, error) {
...
func (o InlineObject27Args) ToMap() (map[string]interface{}, error) {
...
func (o *InlineObject27Args) UnmarshalJSON(data []byte) (err error) {
	varInlineObject27Args := _InlineObject27Args{}

	err = json.Unmarshal(data, &varInlineObject27Args)

	if err != nil {
		return err
	}

	*o = InlineObject27Args(varInlineObject27Args)
...
type NullableInlineObject27Args struct {
	value *InlineObject27Args
	isSet bool
}

func (v NullableInlineObject27Args) Get() *InlineObject27Args {
	return v.value
}

func (v *NullableInlineObject27Args) Set(val *InlineObject27Args) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject27Args) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject27Args) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject27Args(val *InlineObject27Args) *NullableInlineObject27Args {
	return &NullableInlineObject27Args{value: val, isSet: true}
}

func (v NullableInlineObject27Args) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject27Args) UnmarshalJSON(src []byte) error {
	v.isSet = true
