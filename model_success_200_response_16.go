...
// checks if the Success200Response16 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &Success200Response16{}

// Success200Response16 struct for Success200Response16
type Success200Response16 struct {
	...
	Integration *Success200Response16Integration `json:"integration,omitempty"`
...
type _Success200Response16 Success200Response16
...
func (o *Success200Response16) GetIntegration() Success200Response16Integration {
	if o == nil || IsNil(o.Integration) {
		var ret Success200Response16Integration
		return ret
	}
...
// SetIntegration gets a reference to the given Success200Response16Integration and assigns it to the Integration field.
...
func (o Success200Response16) MarshalJSON() ([]byte, error) {
...
func (o Success200Response16) ToMap() (map[string]interface{}, error) {
...
func (o *Success200Response16) UnmarshalJSON(data []byte) (err error) {
	varSuccess200Response16 := _Success200Response16{}

	err = json.Unmarshal(data, &varSuccess200Response16)

	if err != nil {
		return err
	}

	*o = Success200Response16(varSuccess200Response16)
...
type NullableSuccess200Response16 struct {
	value *Success200Response16
	isSet bool
}

func (v NullableSuccess200Response16) Get() *Success200Response16 {
	return v.value
}

func (v *NullableSuccess200Response16) Set(val *Success200Response16) {
	v.value = val
	v.isSet = true
}

func (v NullableSuccess200Response16) IsSet() bool {
	return v.isSet
}

func (v *NullableSuccess200Response16) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSuccess200Response16(val *Success200Response16) *NullableSuccess200Response16 {
	return &NullableSuccess200Response16{value: val, isSet: true}
}

func (v NullableSuccess200Response16) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSuccess200Response16) UnmarshalJSON(src []byte) error {
	v.isSet = true
