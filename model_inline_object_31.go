...
// checks if the InlineObject31 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &InlineObject31{}
...
type _InlineObject31 InlineObject31
...
func (o InlineObject31) ToMap() (map[string]interface{}, error) {
...
func (o *InlineObject31) UnmarshalJSON(data []byte) (err error) {
	varInlineObject31 := _InlineObject31{}

	err = json.Unmarshal(data, &varInlineObject31)

	if err != nil {
		return err
	}

	*o = InlineObject31(varInlineObject31)
