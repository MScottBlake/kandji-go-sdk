...
// checks if the InlineObject32 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &InlineObject32{}
...
type _InlineObject32 InlineObject32
...
func (o *InlineObject32) HasCount() bool {
	if o != nil && !IsNil(o.Count) {
		return true
	}
...
func (o InlineObject32) ToMap() (map[string]interface{}, error) {
...
func (o *InlineObject32) UnmarshalJSON(data []byte) (err error) {
	varInlineObject32 := _InlineObject32{}

	err = json.Unmarshal(data, &varInlineObject32)

	if err != nil {
		return err
	}

	*o = InlineObject32(varInlineObject32)
