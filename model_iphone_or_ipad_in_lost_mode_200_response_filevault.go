...
// checks if the IphoneOrIpadInLostMode200ResponseFilevault type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IphoneOrIpadInLostMode200ResponseFilevault{}

// IphoneOrIpadInLostMode200ResponseFilevault struct for IphoneOrIpadInLostMode200ResponseFilevault
type IphoneOrIpadInLostMode200ResponseFilevault struct {
...
type _IphoneOrIpadInLostMode200ResponseFilevault IphoneOrIpadInLostMode200ResponseFilevault
...
func NewIphoneOrIpadInLostMode200ResponseFilevault() *IphoneOrIpadInLostMode200ResponseFilevault {
	this := IphoneOrIpadInLostMode200ResponseFilevault{}
	return &this
}
...
func (o IphoneOrIpadInLostMode200ResponseFilevault) MarshalJSON() ([]byte, error) {
...
func (o IphoneOrIpadInLostMode200ResponseFilevault) ToMap() (map[string]interface{}, error) {
...
func (o *IphoneOrIpadInLostMode200ResponseFilevault) UnmarshalJSON(data []byte) (err error) {
	varIphoneOrIpadInLostMode200ResponseFilevault := _IphoneOrIpadInLostMode200ResponseFilevault{}

	err = json.Unmarshal(data, &varIphoneOrIpadInLostMode200ResponseFilevault)

	if err != nil {
		return err
	}

	*o = IphoneOrIpadInLostMode200ResponseFilevault(varIphoneOrIpadInLostMode200ResponseFilevault)
...
type NullableIphoneOrIpadInLostMode200ResponseFilevault struct {
	value *IphoneOrIpadInLostMode200ResponseFilevault
	isSet bool
}

func (v NullableIphoneOrIpadInLostMode200ResponseFilevault) Get() *IphoneOrIpadInLostMode200ResponseFilevault {
	return v.value
}

func (v *NullableIphoneOrIpadInLostMode200ResponseFilevault) Set(val *IphoneOrIpadInLostMode200ResponseFilevault) {
	v.value = val
	v.isSet = true
}

func (v NullableIphoneOrIpadInLostMode200ResponseFilevault) IsSet() bool {
	return v.isSet
}

func (v *NullableIphoneOrIpadInLostMode200ResponseFilevault) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIphoneOrIpadInLostMode200ResponseFilevault(val *IphoneOrIpadInLostMode200ResponseFilevault) *NullableIphoneOrIpadInLostMode200ResponseFilevault {
	return &NullableIphoneOrIpadInLostMode200ResponseFilevault{value: val, isSet: true}
}

func (v NullableIphoneOrIpadInLostMode200ResponseFilevault) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIphoneOrIpadInLostMode200ResponseFilevault) UnmarshalJSON(src []byte) error {
	v.isSet = true
