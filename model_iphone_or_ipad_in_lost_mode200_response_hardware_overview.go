...
// checks if the IphoneOrIpadInLostMode200ResponseHardwareOverview type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IphoneOrIpadInLostMode200ResponseHardwareOverview{}

// IphoneOrIpadInLostMode200ResponseHardwareOverview struct for IphoneOrIpadInLostMode200ResponseHardwareOverview
type IphoneOrIpadInLostMode200ResponseHardwareOverview struct {
...
type _IphoneOrIpadInLostMode200ResponseHardwareOverview IphoneOrIpadInLostMode200ResponseHardwareOverview
...
func NewIphoneOrIpadInLostMode200ResponseHardwareOverview() *IphoneOrIpadInLostMode200ResponseHardwareOverview {
	this := IphoneOrIpadInLostMode200ResponseHardwareOverview{}
	return &this
}
...
func (o IphoneOrIpadInLostMode200ResponseHardwareOverview) MarshalJSON() ([]byte, error) {
...
func (o IphoneOrIpadInLostMode200ResponseHardwareOverview) ToMap() (map[string]interface{}, error) {
...
func (o *IphoneOrIpadInLostMode200ResponseHardwareOverview) UnmarshalJSON(data []byte) (err error) {
	varIphoneOrIpadInLostMode200ResponseHardwareOverview := _IphoneOrIpadInLostMode200ResponseHardwareOverview{}

	err = json.Unmarshal(data, &varIphoneOrIpadInLostMode200ResponseHardwareOverview)

	if err != nil {
		return err
	}

	*o = IphoneOrIpadInLostMode200ResponseHardwareOverview(varIphoneOrIpadInLostMode200ResponseHardwareOverview)
...
type NullableIphoneOrIpadInLostMode200ResponseHardwareOverview struct {
	value *IphoneOrIpadInLostMode200ResponseHardwareOverview
	isSet bool
}

func (v NullableIphoneOrIpadInLostMode200ResponseHardwareOverview) Get() *IphoneOrIpadInLostMode200ResponseHardwareOverview {
	return v.value
}

func (v *NullableIphoneOrIpadInLostMode200ResponseHardwareOverview) Set(val *IphoneOrIpadInLostMode200ResponseHardwareOverview) {
	v.value = val
	v.isSet = true
}

func (v NullableIphoneOrIpadInLostMode200ResponseHardwareOverview) IsSet() bool {
	return v.isSet
}

func (v *NullableIphoneOrIpadInLostMode200ResponseHardwareOverview) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIphoneOrIpadInLostMode200ResponseHardwareOverview(val *IphoneOrIpadInLostMode200ResponseHardwareOverview) *NullableIphoneOrIpadInLostMode200ResponseHardwareOverview {
	return &NullableIphoneOrIpadInLostMode200ResponseHardwareOverview{value: val, isSet: true}
}

func (v NullableIphoneOrIpadInLostMode200ResponseHardwareOverview) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIphoneOrIpadInLostMode200ResponseHardwareOverview) UnmarshalJSON(src []byte) error {
	v.isSet = true
