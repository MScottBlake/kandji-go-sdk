...
// checks if the IphoneOrIpadInLostMode200ResponseKandjiAgent type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IphoneOrIpadInLostMode200ResponseKandjiAgent{}

// IphoneOrIpadInLostMode200ResponseKandjiAgent struct for IphoneOrIpadInLostMode200ResponseKandjiAgent
type IphoneOrIpadInLostMode200ResponseKandjiAgent struct {
...
type _IphoneOrIpadInLostMode200ResponseKandjiAgent IphoneOrIpadInLostMode200ResponseKandjiAgent
...
func NewIphoneOrIpadInLostMode200ResponseKandjiAgent() *IphoneOrIpadInLostMode200ResponseKandjiAgent {
	this := IphoneOrIpadInLostMode200ResponseKandjiAgent{}
	return &this
}
...
func (o IphoneOrIpadInLostMode200ResponseKandjiAgent) MarshalJSON() ([]byte, error) {
...
func (o IphoneOrIpadInLostMode200ResponseKandjiAgent) ToMap() (map[string]interface{}, error) {
...
func (o *IphoneOrIpadInLostMode200ResponseKandjiAgent) UnmarshalJSON(data []byte) (err error) {
	varIphoneOrIpadInLostMode200ResponseKandjiAgent := _IphoneOrIpadInLostMode200ResponseKandjiAgent{}

	err = json.Unmarshal(data, &varIphoneOrIpadInLostMode200ResponseKandjiAgent)

	if err != nil {
		return err
	}

	*o = IphoneOrIpadInLostMode200ResponseKandjiAgent(varIphoneOrIpadInLostMode200ResponseKandjiAgent)
...
type NullableIphoneOrIpadInLostMode200ResponseKandjiAgent struct {
	value *IphoneOrIpadInLostMode200ResponseKandjiAgent
	isSet bool
}

func (v NullableIphoneOrIpadInLostMode200ResponseKandjiAgent) Get() *IphoneOrIpadInLostMode200ResponseKandjiAgent {
	return v.value
}

func (v *NullableIphoneOrIpadInLostMode200ResponseKandjiAgent) Set(val *IphoneOrIpadInLostMode200ResponseKandjiAgent) {
	v.value = val
	v.isSet = true
}

func (v NullableIphoneOrIpadInLostMode200ResponseKandjiAgent) IsSet() bool {
	return v.isSet
}

func (v *NullableIphoneOrIpadInLostMode200ResponseKandjiAgent) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIphoneOrIpadInLostMode200ResponseKandjiAgent(val *IphoneOrIpadInLostMode200ResponseKandjiAgent) *NullableIphoneOrIpadInLostMode200ResponseKandjiAgent {
	return &NullableIphoneOrIpadInLostMode200ResponseKandjiAgent{value: val, isSet: true}
}

func (v NullableIphoneOrIpadInLostMode200ResponseKandjiAgent) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIphoneOrIpadInLostMode200ResponseKandjiAgent) UnmarshalJSON(src []byte) error {
	v.isSet = true
