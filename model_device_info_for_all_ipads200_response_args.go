...
// checks if the DeviceInfoForAllIpads200ResponseArgs type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DeviceInfoForAllIpads200ResponseArgs{}

// DeviceInfoForAllIpads200ResponseArgs struct for DeviceInfoForAllIpads200ResponseArgs
type DeviceInfoForAllIpads200ResponseArgs struct {
...
type _DeviceInfoForAllIpads200ResponseArgs DeviceInfoForAllIpads200ResponseArgs
...
func NewDeviceInfoForAllIpads200ResponseArgs() *DeviceInfoForAllIpads200ResponseArgs {
	this := DeviceInfoForAllIpads200ResponseArgs{}
	return &this
}
...
func (o *DeviceInfoForAllIpads200ResponseArgs) SetSortBy(v string) {
	o.SortBy = &v
}
...
func (o DeviceInfoForAllIpads200ResponseArgs) MarshalJSON() ([]byte, error) {
...
func (o DeviceInfoForAllIpads200ResponseArgs) ToMap() (map[string]interface{}, error) {
...
func (o *DeviceInfoForAllIpads200ResponseArgs) UnmarshalJSON(data []byte) (err error) {
	varDeviceInfoForAllIpads200ResponseArgs := _DeviceInfoForAllIpads200ResponseArgs{}

	err = json.Unmarshal(data, &varDeviceInfoForAllIpads200ResponseArgs)

	if err != nil {
		return err
	}

	*o = DeviceInfoForAllIpads200ResponseArgs(varDeviceInfoForAllIpads200ResponseArgs)
...
type NullableDeviceInfoForAllIpads200ResponseArgs struct {
	value *DeviceInfoForAllIpads200ResponseArgs
	isSet bool
}

func (v NullableDeviceInfoForAllIpads200ResponseArgs) Get() *DeviceInfoForAllIpads200ResponseArgs {
	return v.value
}

func (v *NullableDeviceInfoForAllIpads200ResponseArgs) Set(val *DeviceInfoForAllIpads200ResponseArgs) {
	v.value = val
	v.isSet = true
}

func (v NullableDeviceInfoForAllIpads200ResponseArgs) IsSet() bool {
	return v.isSet
}

func (v *NullableDeviceInfoForAllIpads200ResponseArgs) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDeviceInfoForAllIpads200ResponseArgs(val *DeviceInfoForAllIpads200ResponseArgs) *NullableDeviceInfoForAllIpads200ResponseArgs {
	return &NullableDeviceInfoForAllIpads200ResponseArgs{value: val, isSet: true}
}

func (v NullableDeviceInfoForAllIpads200ResponseArgs) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDeviceInfoForAllIpads200ResponseArgs) UnmarshalJSON(src []byte) error {
	v.isSet = true
