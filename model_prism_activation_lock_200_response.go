...
// checks if the PrismActivationLock200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PrismActivationLock200Response{}
...
type _PrismActivationLock200Response PrismActivationLock200Response
...
func (o *PrismActivationLock200Response) UnmarshalJSON(data []byte) (err error) {
	varPrismActivationLock200Response := _PrismActivationLock200Response{}

	err = json.Unmarshal(data, &varPrismActivationLock200Response)

	if err != nil {
		return err
	}

	*o = PrismActivationLock200Response(varPrismActivationLock200Response)
...
type NullablePrismActivationLock200Response struct {
	value *PrismActivationLock200Response
	isSet bool
}

func (v NullablePrismActivationLock200Response) Get() *PrismActivationLock200Response {
	return v.value
}

func (v *NullablePrismActivationLock200Response) Set(val *PrismActivationLock200Response) {
	v.value = val
	v.isSet = true
}

func (v NullablePrismActivationLock200Response) IsSet() bool {
	return v.isSet
}

func (v *NullablePrismActivationLock200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePrismActivationLock200Response(val *PrismActivationLock200Response) *NullablePrismActivationLock200Response {
	return &NullablePrismActivationLock200Response{value: val, isSet: true}
}

func (v NullablePrismActivationLock200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePrismActivationLock200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
