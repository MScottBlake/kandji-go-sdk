...
// checks if the InlineObject36 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &InlineObject36{}
...
type _InlineObject36 InlineObject36
...
func (o InlineObject36) ToMap() (map[string]interface{}, error) {
...
func (o *InlineObject36) UnmarshalJSON(data []byte) (err error) {
	varInlineObject36 := _InlineObject36{}

	err = json.Unmarshal(data, &varInlineObject36)

	if err != nil {
		return err
	}

	*o = InlineObject36(varInlineObject36)
