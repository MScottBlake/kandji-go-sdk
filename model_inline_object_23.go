...
// checks if the InlineObject23 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &InlineObject23{}
...
type _InlineObject23 InlineObject23
...
func (o InlineObject23) ToMap() (map[string]interface{}, error) {
...
func (o *InlineObject23) UnmarshalJSON(data []byte) (err error) {
	varInlineObject23 := _InlineObject23{}

	err = json.Unmarshal(data, &varInlineObject23)

	if err != nil {
		return err
	}

	*o = InlineObject23(varInlineObject23)
