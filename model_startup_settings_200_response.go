...
// checks if the StartupSettings200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &StartupSettings200Response{}

// StartupSettings200Response struct for StartupSettings200Response
type StartupSettings200Response struct {
...
type _StartupSettings200Response StartupSettings200Response
...
func NewStartupSettings200Response() *StartupSettings200Response {
	this := StartupSettings200Response{}
	return &this
}
...
func (o StartupSettings200Response) MarshalJSON() ([]byte, error) {
...
func (o StartupSettings200Response) ToMap() (map[string]interface{}, error) {
...
func (o *StartupSettings200Response) UnmarshalJSON(data []byte) (err error) {
	varStartupSettings200Response := _StartupSettings200Response{}

	err = json.Unmarshal(data, &varStartupSettings200Response)

	if err != nil {
		return err
	}

	*o = StartupSettings200Response(varStartupSettings200Response)
...
type NullableStartupSettings200Response struct {
	value *StartupSettings200Response
	isSet bool
}

func (v NullableStartupSettings200Response) Get() *StartupSettings200Response {
	return v.value
}

func (v *NullableStartupSettings200Response) Set(val *StartupSettings200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableStartupSettings200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableStartupSettings200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableStartupSettings200Response(val *StartupSettings200Response) *NullableStartupSettings200Response {
	return &NullableStartupSettings200Response{value: val, isSet: true}
}

func (v NullableStartupSettings200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableStartupSettings200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
