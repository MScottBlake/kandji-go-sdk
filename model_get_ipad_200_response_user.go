...
// checks if the GetIpad200ResponseUser type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetIpad200ResponseUser{}

// GetIpad200ResponseUser struct for GetIpad200ResponseUser
type GetIpad200ResponseUser struct {
...
type _GetIpad200ResponseUser GetIpad200ResponseUser
...
func (o GetIpad200ResponseUser) MarshalJSON() ([]byte, error) {
...
func (o GetIpad200ResponseUser) ToMap() (map[string]interface{}, error) {
...
func (o *GetIpad200ResponseUser) UnmarshalJSON(data []byte) (err error) {
	varGetIpad200ResponseUser := _GetIpad200ResponseUser{}

	err = json.Unmarshal(data, &varGetIpad200ResponseUser)

	if err != nil {
		return err
	}

	*o = GetIpad200ResponseUser(varGetIpad200ResponseUser)
...
type NullableGetIpad200ResponseUser struct {
	value *GetIpad200ResponseUser
	isSet bool
}

func (v NullableGetIpad200ResponseUser) Get() *GetIpad200ResponseUser {
	return v.value
}

func (v *NullableGetIpad200ResponseUser) Set(val *GetIpad200ResponseUser) {
	v.value = val
	v.isSet = true
}

func (v NullableGetIpad200ResponseUser) IsSet() bool {
	return v.isSet
}

func (v *NullableGetIpad200ResponseUser) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetIpad200ResponseUser(val *GetIpad200ResponseUser) *NullableGetIpad200ResponseUser {
	return &NullableGetIpad200ResponseUser{value: val, isSet: true}
}

func (v NullableGetIpad200ResponseUser) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetIpad200ResponseUser) UnmarshalJSON(src []byte) error {
	v.isSet = true
