...
// checks if the InlineObject10General type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &InlineObject10General{}

// InlineObject10General struct for InlineObject10General
type InlineObject10General struct {
...
type _InlineObject10General InlineObject10General
...
func (o *InlineObject10General) GetDeviceIdOk() (*string, bool) {
	if o == nil || IsNil(o.DeviceId) {
		return nil, false
	}
...
func (o *InlineObject10General) SetLastEnrollment(v string) {
	o.LastEnrollment = &v
}
...
func (o *InlineObject10General) HasModel() bool {
	if o != nil && !IsNil(o.Model) {
		return true
	}
...
// and a boolean to check if the value has been set.
func (o *InlineObject10General) GetSystemVersionOk() (*string, bool) {
	if o == nil || IsNil(o.SystemVersion) {
		return nil, false
	}
...
func (o *InlineObject10General) HasAssetTag() bool {
	if o != nil && !IsNil(o.AssetTag) {
		return true
	}
...
func (o *InlineObject10General) GetBlueprintUuid() string {
...
func (o InlineObject10General) MarshalJSON() ([]byte, error) {
...
func (o InlineObject10General) ToMap() (map[string]interface{}, error) {
...
func (o *InlineObject10General) UnmarshalJSON(data []byte) (err error) {
	varInlineObject10General := _InlineObject10General{}

	err = json.Unmarshal(data, &varInlineObject10General)

	if err != nil {
		return err
	}

	*o = InlineObject10General(varInlineObject10General)
...
type NullableInlineObject10General struct {
	value *InlineObject10General
	isSet bool
}

func (v NullableInlineObject10General) Get() *InlineObject10General {
	return v.value
}

func (v *NullableInlineObject10General) Set(val *InlineObject10General) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject10General) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject10General) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject10General(val *InlineObject10General) *NullableInlineObject10General {
	return &NullableInlineObject10General{value: val, isSet: true}
}

func (v NullableInlineObject10General) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject10General) UnmarshalJSON(src []byte) error {
	v.isSet = true
