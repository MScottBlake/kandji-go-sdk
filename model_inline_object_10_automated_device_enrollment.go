...
// checks if the InlineObject10AutomatedDeviceEnrollment type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &InlineObject10AutomatedDeviceEnrollment{}

// InlineObject10AutomatedDeviceEnrollment struct for InlineObject10AutomatedDeviceEnrollment
type InlineObject10AutomatedDeviceEnrollment struct {
	AutoEnrollEligible *int32 `json:"auto_enroll_eligible,omitempty"`
	AutoEnrolled *int32 `json:"auto_enrolled,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _InlineObject10AutomatedDeviceEnrollment InlineObject10AutomatedDeviceEnrollment
...
func NewInlineObject10AutomatedDeviceEnrollment() *InlineObject10AutomatedDeviceEnrollment {
	this := InlineObject10AutomatedDeviceEnrollment{}
	return &this
}
...
func (o InlineObject10AutomatedDeviceEnrollment) MarshalJSON() ([]byte, error) {
...
func (o InlineObject10AutomatedDeviceEnrollment) ToMap() (map[string]interface{}, error) {
...
func (o *InlineObject10AutomatedDeviceEnrollment) UnmarshalJSON(data []byte) (err error) {
	varInlineObject10AutomatedDeviceEnrollment := _InlineObject10AutomatedDeviceEnrollment{}

	err = json.Unmarshal(data, &varInlineObject10AutomatedDeviceEnrollment)

	if err != nil {
		return err
	}

	*o = InlineObject10AutomatedDeviceEnrollment(varInlineObject10AutomatedDeviceEnrollment)
...
type NullableInlineObject10AutomatedDeviceEnrollment struct {
	value *InlineObject10AutomatedDeviceEnrollment
	isSet bool
}

func (v NullableInlineObject10AutomatedDeviceEnrollment) Get() *InlineObject10AutomatedDeviceEnrollment {
	return v.value
}

func (v *NullableInlineObject10AutomatedDeviceEnrollment) Set(val *InlineObject10AutomatedDeviceEnrollment) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject10AutomatedDeviceEnrollment) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject10AutomatedDeviceEnrollment) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject10AutomatedDeviceEnrollment(val *InlineObject10AutomatedDeviceEnrollment) *NullableInlineObject10AutomatedDeviceEnrollment {
	return &NullableInlineObject10AutomatedDeviceEnrollment{value: val, isSet: true}
}

func (v NullableInlineObject10AutomatedDeviceEnrollment) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject10AutomatedDeviceEnrollment) UnmarshalJSON(src []byte) error {
	v.isSet = true
