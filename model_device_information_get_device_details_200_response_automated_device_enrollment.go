...
// checks if the DeviceInformationGetDeviceDetails200ResponseAutomatedDeviceEnrollment type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DeviceInformationGetDeviceDetails200ResponseAutomatedDeviceEnrollment{}

// DeviceInformationGetDeviceDetails200ResponseAutomatedDeviceEnrollment struct for DeviceInformationGetDeviceDetails200ResponseAutomatedDeviceEnrollment
type DeviceInformationGetDeviceDetails200ResponseAutomatedDeviceEnrollment struct {
	AutoEnrollEligible *int32 `json:"auto_enroll_eligible,omitempty"`
	AutoEnrolled *int32 `json:"auto_enrolled,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _DeviceInformationGetDeviceDetails200ResponseAutomatedDeviceEnrollment DeviceInformationGetDeviceDetails200ResponseAutomatedDeviceEnrollment
...
func NewDeviceInformationGetDeviceDetails200ResponseAutomatedDeviceEnrollment() *DeviceInformationGetDeviceDetails200ResponseAutomatedDeviceEnrollment {
	this := DeviceInformationGetDeviceDetails200ResponseAutomatedDeviceEnrollment{}
	return &this
}
...
func (o DeviceInformationGetDeviceDetails200ResponseAutomatedDeviceEnrollment) MarshalJSON() ([]byte, error) {
...
func (o DeviceInformationGetDeviceDetails200ResponseAutomatedDeviceEnrollment) ToMap() (map[string]interface{}, error) {
...
func (o *DeviceInformationGetDeviceDetails200ResponseAutomatedDeviceEnrollment) UnmarshalJSON(data []byte) (err error) {
	varDeviceInformationGetDeviceDetails200ResponseAutomatedDeviceEnrollment := _DeviceInformationGetDeviceDetails200ResponseAutomatedDeviceEnrollment{}

	err = json.Unmarshal(data, &varDeviceInformationGetDeviceDetails200ResponseAutomatedDeviceEnrollment)

	if err != nil {
		return err
	}

	*o = DeviceInformationGetDeviceDetails200ResponseAutomatedDeviceEnrollment(varDeviceInformationGetDeviceDetails200ResponseAutomatedDeviceEnrollment)
...
type NullableDeviceInformationGetDeviceDetails200ResponseAutomatedDeviceEnrollment struct {
	value *DeviceInformationGetDeviceDetails200ResponseAutomatedDeviceEnrollment
	isSet bool
}

func (v NullableDeviceInformationGetDeviceDetails200ResponseAutomatedDeviceEnrollment) Get() *DeviceInformationGetDeviceDetails200ResponseAutomatedDeviceEnrollment {
	return v.value
}

func (v *NullableDeviceInformationGetDeviceDetails200ResponseAutomatedDeviceEnrollment) Set(val *DeviceInformationGetDeviceDetails200ResponseAutomatedDeviceEnrollment) {
	v.value = val
	v.isSet = true
}

func (v NullableDeviceInformationGetDeviceDetails200ResponseAutomatedDeviceEnrollment) IsSet() bool {
	return v.isSet
}

func (v *NullableDeviceInformationGetDeviceDetails200ResponseAutomatedDeviceEnrollment) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDeviceInformationGetDeviceDetails200ResponseAutomatedDeviceEnrollment(val *DeviceInformationGetDeviceDetails200ResponseAutomatedDeviceEnrollment) *NullableDeviceInformationGetDeviceDetails200ResponseAutomatedDeviceEnrollment {
	return &NullableDeviceInformationGetDeviceDetails200ResponseAutomatedDeviceEnrollment{value: val, isSet: true}
}

func (v NullableDeviceInformationGetDeviceDetails200ResponseAutomatedDeviceEnrollment) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDeviceInformationGetDeviceDetails200ResponseAutomatedDeviceEnrollment) UnmarshalJSON(src []byte) error {
	v.isSet = true
