...
// checks if the InlineObject19 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &InlineObject19{}
...
type _InlineObject19 InlineObject19
...
func (o InlineObject19) ToMap() (map[string]interface{}, error) {
...
func (o *InlineObject19) UnmarshalJSON(data []byte) (err error) {
	varInlineObject19 := _InlineObject19{}

	err = json.Unmarshal(data, &varInlineObject19)

	if err != nil {
		return err
	}

	*o = InlineObject19(varInlineObject19)
