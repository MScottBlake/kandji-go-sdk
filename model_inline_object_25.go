...
// checks if the InlineObject25 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &InlineObject25{}
...
type _InlineObject25 InlineObject25
...
func (o InlineObject25) ToMap() (map[string]interface{}, error) {
...
func (o *InlineObject25) UnmarshalJSON(data []byte) (err error) {
	varInlineObject25 := _InlineObject25{}

	err = json.Unmarshal(data, &varInlineObject25)

	if err != nil {
		return err
	}

	*o = InlineObject25(varInlineObject25)
