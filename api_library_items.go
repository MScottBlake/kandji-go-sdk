...
<p><code>library_item_id</code> (path parameter): The unique identifier of the library item.</p>
	...
	*/
	...
	GetLibraryItemActivityExecute(r ApiGetLibraryItemActivityRequest) (*BlueprintsListBlueprints200Response, *http.Response, error)
...
<p><code>library_item_id</code> (path parameter): The unique identifier of the library item.</p>
	...
	*/
	...
	//  @return BlueprintsListBlueprints200Response
	GetLibraryItemStatusesExecute(r ApiGetLibraryItemStatusesRequest) (*BlueprintsListBlueprints200Response, *http.Response, error)
}
...
func (r ApiGetLibraryItemActivityRequest) Execute() (*BlueprintsListBlueprints200Response, *http.Response, error) {
...
//  @return BlueprintsListBlueprints200Response
func (a *LibraryItemsAPIService) GetLibraryItemActivityExecute(r ApiGetLibraryItemActivityRequest) (*BlueprintsListBlueprints200Response, *http.Response, error) {
	var (
	...
	if r.activityType != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "activity_type", r.activityType, "form", "")
	}
	if r.userId != nil {
...
func (r ApiGetLibraryItemStatusesRequest) Execute() (*BlueprintsListBlueprints200Response, *http.Response, error) {
...
// Execute executes the request
//  @return BlueprintsListBlueprints200Response
func (a *LibraryItemsAPIService) GetLibraryItemStatusesExecute(r ApiGetLibraryItemStatusesRequest) (*BlueprintsListBlueprints200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	if r.computerId != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "computer_id", r.computerId, "form", "")
	}
	if r.limit != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "limit", r.limit, "form", "")
	}
