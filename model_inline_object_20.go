...
type _InlineObject20 InlineObject20
...
func (o *InlineObject20) UnmarshalJSON(data []byte) (err error) {
	varInlineObject20 := _InlineObject20{}

	err = json.Unmarshal(data, &varInlineObject20)

	if err != nil {
		return err
	}

	*o = InlineObject20(varInlineObject20)
