...
// checks if the IphoneOrIpadInLostMode200ResponseAppleBusinessManager type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IphoneOrIpadInLostMode200ResponseAppleBusinessManager{}

// IphoneOrIpadInLostMode200ResponseAppleBusinessManager struct for IphoneOrIpadInLostMode200ResponseAppleBusinessManager
type IphoneOrIpadInLostMode200ResponseAppleBusinessManager struct {
...
type _IphoneOrIpadInLostMode200ResponseAppleBusinessManager IphoneOrIpadInLostMode200ResponseAppleBusinessManager
...
func NewIphoneOrIpadInLostMode200ResponseAppleBusinessManager() *IphoneOrIpadInLostMode200ResponseAppleBusinessManager {
	this := IphoneOrIpadInLostMode200ResponseAppleBusinessManager{}
	return &this
}
...
func (o *IphoneOrIpadInLostMode200ResponseAppleBusinessManager) GetDeviceAssignedBy() string {
...
func (o IphoneOrIpadInLostMode200ResponseAppleBusinessManager) MarshalJSON() ([]byte, error) {
...
func (o IphoneOrIpadInLostMode200ResponseAppleBusinessManager) ToMap() (map[string]interface{}, error) {
...
func (o *IphoneOrIpadInLostMode200ResponseAppleBusinessManager) UnmarshalJSON(data []byte) (err error) {
	varIphoneOrIpadInLostMode200ResponseAppleBusinessManager := _IphoneOrIpadInLostMode200ResponseAppleBusinessManager{}

	err = json.Unmarshal(data, &varIphoneOrIpadInLostMode200ResponseAppleBusinessManager)

	if err != nil {
		return err
	}

	*o = IphoneOrIpadInLostMode200ResponseAppleBusinessManager(varIphoneOrIpadInLostMode200ResponseAppleBusinessManager)
...
type NullableIphoneOrIpadInLostMode200ResponseAppleBusinessManager struct {
	value *IphoneOrIpadInLostMode200ResponseAppleBusinessManager
	isSet bool
}

func (v NullableIphoneOrIpadInLostMode200ResponseAppleBusinessManager) Get() *IphoneOrIpadInLostMode200ResponseAppleBusinessManager {
	return v.value
}

func (v *NullableIphoneOrIpadInLostMode200ResponseAppleBusinessManager) Set(val *IphoneOrIpadInLostMode200ResponseAppleBusinessManager) {
	v.value = val
	v.isSet = true
}

func (v NullableIphoneOrIpadInLostMode200ResponseAppleBusinessManager) IsSet() bool {
	return v.isSet
}

func (v *NullableIphoneOrIpadInLostMode200ResponseAppleBusinessManager) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIphoneOrIpadInLostMode200ResponseAppleBusinessManager(val *IphoneOrIpadInLostMode200ResponseAppleBusinessManager) *NullableIphoneOrIpadInLostMode200ResponseAppleBusinessManager {
	return &NullableIphoneOrIpadInLostMode200ResponseAppleBusinessManager{value: val, isSet: true}
}

func (v NullableIphoneOrIpadInLostMode200ResponseAppleBusinessManager) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIphoneOrIpadInLostMode200ResponseAppleBusinessManager) UnmarshalJSON(src []byte) error {
	v.isSet = true
