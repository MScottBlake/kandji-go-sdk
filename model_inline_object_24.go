...
// checks if the InlineObject24 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &InlineObject24{}
...
type _InlineObject24 InlineObject24
...
func (o InlineObject24) ToMap() (map[string]interface{}, error) {
...
func (o *InlineObject24) UnmarshalJSON(data []byte) (err error) {
	varInlineObject24 := _InlineObject24{}

	err = json.Unmarshal(data, &varInlineObject24)

	if err != nil {
		return err
	}

	*o = InlineObject24(varInlineObject24)
