...
// checks if the InlineObject26 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &InlineObject26{}
...
type _InlineObject26 InlineObject26
...
func (o InlineObject26) ToMap() (map[string]interface{}, error) {
...
func (o *InlineObject26) UnmarshalJSON(data []byte) (err error) {
	varInlineObject26 := _InlineObject26{}

	err = json.Unmarshal(data, &varInlineObject26)

	if err != nil {
		return err
	}

	*o = InlineObject26(varInlineObject26)
