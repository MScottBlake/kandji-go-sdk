...
// checks if the Success200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &Success200Response{}

// Success200Response struct for Success200Response
...
type _Success200Response Success200Response
...
func (o Success200Response) MarshalJSON() ([]byte, error) {
...
func (o Success200Response) ToMap() (map[string]interface{}, error) {
...
func (o *Success200Response) UnmarshalJSON(data []byte) (err error) {
	varSuccess200Response := _Success200Response{}

	err = json.Unmarshal(data, &varSuccess200Response)

	if err != nil {
		return err
	}

	*o = Success200Response(varSuccess200Response)
...
type NullableSuccess200Response struct {
	value *Success200Response
	isSet bool
}

func (v NullableSuccess200Response) Get() *Success200Response {
	return v.value
}

func (v *NullableSuccess200Response) Set(val *Success200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableSuccess200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableSuccess200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSuccess200Response(val *Success200Response) *NullableSuccess200Response {
	return &NullableSuccess200Response{value: val, isSet: true}
}

func (v NullableSuccess200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSuccess200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
