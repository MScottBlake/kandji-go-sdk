...
// checks if the DeviceSecretsGetActivationLockBypassCode200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DeviceSecretsGetActivationLockBypassCode200Response{}
...
type _DeviceSecretsGetActivationLockBypassCode200Response DeviceSecretsGetActivationLockBypassCode200Response
...
func (o *DeviceSecretsGetActivationLockBypassCode200Response) GetDeviceBasedAlbc() string {
	if o == nil || IsNil(o.DeviceBasedAlbc) {
		var ret string
		return ret
	}
	return *o.DeviceBasedAlbc
}

// GetDeviceBasedAlbcOk returns a tuple with the DeviceBasedAlbc field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *DeviceSecretsGetActivationLockBypassCode200Response) GetDeviceBasedAlbcOk() (*string, bool) {
	if o == nil || IsNil(o.DeviceBasedAlbc) {
		return nil, false
	}
	return o.DeviceBasedAlbc, true
}
...
// SetDeviceBasedAlbc gets a reference to the given string and assigns it to the DeviceBasedAlbc field.
...
func (o *DeviceSecretsGetActivationLockBypassCode200Response) UnmarshalJSON(data []byte) (err error) {
	varDeviceSecretsGetActivationLockBypassCode200Response := _DeviceSecretsGetActivationLockBypassCode200Response{}

	err = json.Unmarshal(data, &varDeviceSecretsGetActivationLockBypassCode200Response)

	if err != nil {
		return err
	}

	*o = DeviceSecretsGetActivationLockBypassCode200Response(varDeviceSecretsGetActivationLockBypassCode200Response)
...
type NullableDeviceSecretsGetActivationLockBypassCode200Response struct {
	value *DeviceSecretsGetActivationLockBypassCode200Response
	isSet bool
}

func (v NullableDeviceSecretsGetActivationLockBypassCode200Response) Get() *DeviceSecretsGetActivationLockBypassCode200Response {
	return v.value
}

func (v *NullableDeviceSecretsGetActivationLockBypassCode200Response) Set(val *DeviceSecretsGetActivationLockBypassCode200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableDeviceSecretsGetActivationLockBypassCode200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableDeviceSecretsGetActivationLockBypassCode200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDeviceSecretsGetActivationLockBypassCode200Response(val *DeviceSecretsGetActivationLockBypassCode200Response) *NullableDeviceSecretsGetActivationLockBypassCode200Response {
	return &NullableDeviceSecretsGetActivationLockBypassCode200Response{value: val, isSet: true}
}

func (v NullableDeviceSecretsGetActivationLockBypassCode200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDeviceSecretsGetActivationLockBypassCode200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
