...
// checks if the TagsCreateTag201Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TagsCreateTag201Response{}

// TagsCreateTag201Response struct for TagsCreateTag201Response
type TagsCreateTag201Response struct {
	Id *string `json:"id,omitempty"`
	Name *string `json:"name,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _TagsCreateTag201Response TagsCreateTag201Response
...
func (o TagsCreateTag201Response) MarshalJSON() ([]byte, error) {
...
func (o TagsCreateTag201Response) ToMap() (map[string]interface{}, error) {
...
func (o *TagsCreateTag201Response) UnmarshalJSON(data []byte) (err error) {
	varTagsCreateTag201Response := _TagsCreateTag201Response{}

	err = json.Unmarshal(data, &varTagsCreateTag201Response)

	if err != nil {
		return err
	}

	*o = TagsCreateTag201Response(varTagsCreateTag201Response)
...
type NullableTagsCreateTag201Response struct {
	value *TagsCreateTag201Response
	isSet bool
}

func (v NullableTagsCreateTag201Response) Get() *TagsCreateTag201Response {
	return v.value
}

func (v *NullableTagsCreateTag201Response) Set(val *TagsCreateTag201Response) {
	v.value = val
	v.isSet = true
}

func (v NullableTagsCreateTag201Response) IsSet() bool {
	return v.isSet
}

func (v *NullableTagsCreateTag201Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTagsCreateTag201Response(val *TagsCreateTag201Response) *NullableTagsCreateTag201Response {
	return &NullableTagsCreateTag201Response{value: val, isSet: true}
}

func (v NullableTagsCreateTag201Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTagsCreateTag201Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
