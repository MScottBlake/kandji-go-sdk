...
// checks if the InlineObject38 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &InlineObject38{}

// InlineObject38 struct for InlineObject38
type InlineObject38 struct {
	Counts *InlineObject38Counts `json:"counts,omitempty"`
	Limits *InlineObject38Limits `json:"limits,omitempty"`
	TenantOverLicenseLimit *int32 `json:"tenantOverLicenseLimit,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _InlineObject38 InlineObject38
...
// SetCounts gets a reference to the given InlineObject38Counts and assigns it to the Counts field.
...
// SetLimits gets a reference to the given InlineObject38Limits and assigns it to the Limits field.
...
func (o InlineObject38) ToMap() (map[string]interface{}, error) {
...
func (o *InlineObject38) UnmarshalJSON(data []byte) (err error) {
	varInlineObject38 := _InlineObject38{}

	err = json.Unmarshal(data, &varInlineObject38)

	if err != nil {
		return err
	}

	*o = InlineObject38(varInlineObject38)
