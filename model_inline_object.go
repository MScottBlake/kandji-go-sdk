...
type InlineObject struct {
	...
	Blueprint *InlineObjectBlueprint `json:"blueprint,omitempty"`
	...
	Defaults *InlineObjectDefaults `json:"defaults,omitempty"`
	...
	DeviceCounts *InlineObjectDeviceCounts `json:"device_counts,omitempty"`
...
// SetBlueprint gets a reference to the given InlineObjectBlueprint and assigns it to the Blueprint field.
...
// SetDefaults gets a reference to the given InlineObjectDefaults and assigns it to the Defaults field.
...
func (o *InlineObject) GetDeviceCounts() InlineObjectDeviceCounts {
	if o == nil || IsNil(o.DeviceCounts) {
		var ret InlineObjectDeviceCounts
		return ret
	}
...
// SetDeviceCounts gets a reference to the given InlineObjectDeviceCounts and assigns it to the DeviceCounts field.
