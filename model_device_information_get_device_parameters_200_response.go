...
// checks if the DeviceInformationGetDeviceParameters200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DeviceInformationGetDeviceParameters200Response{}

// DeviceInformationGetDeviceParameters200Response struct for DeviceInformationGetDeviceParameters200Response
type DeviceInformationGetDeviceParameters200Response struct {
	DeviceId *string `json:"device_id,omitempty"`
	Parameters interface{} `json:"parameters,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _DeviceInformationGetDeviceParameters200Response DeviceInformationGetDeviceParameters200Response
...
func NewDeviceInformationGetDeviceParameters200Response() *DeviceInformationGetDeviceParameters200Response {
	this := DeviceInformationGetDeviceParameters200Response{}
	return &this
}
...
func (o DeviceInformationGetDeviceParameters200Response) MarshalJSON() ([]byte, error) {
...
func (o DeviceInformationGetDeviceParameters200Response) ToMap() (map[string]interface{}, error) {
...
func (o *DeviceInformationGetDeviceParameters200Response) UnmarshalJSON(data []byte) (err error) {
	varDeviceInformationGetDeviceParameters200Response := _DeviceInformationGetDeviceParameters200Response{}

	err = json.Unmarshal(data, &varDeviceInformationGetDeviceParameters200Response)

	if err != nil {
		return err
	}

	*o = DeviceInformationGetDeviceParameters200Response(varDeviceInformationGetDeviceParameters200Response)
...
type NullableDeviceInformationGetDeviceParameters200Response struct {
	value *DeviceInformationGetDeviceParameters200Response
	isSet bool
}

func (v NullableDeviceInformationGetDeviceParameters200Response) Get() *DeviceInformationGetDeviceParameters200Response {
	return v.value
}

func (v *NullableDeviceInformationGetDeviceParameters200Response) Set(val *DeviceInformationGetDeviceParameters200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableDeviceInformationGetDeviceParameters200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableDeviceInformationGetDeviceParameters200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDeviceInformationGetDeviceParameters200Response(val *DeviceInformationGetDeviceParameters200Response) *NullableDeviceInformationGetDeviceParameters200Response {
	return &NullableDeviceInformationGetDeviceParameters200Response{value: val, isSet: true}
}

func (v NullableDeviceInformationGetDeviceParameters200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDeviceInformationGetDeviceParameters200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
