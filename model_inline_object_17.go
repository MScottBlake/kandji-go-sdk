...
type InlineObject17 struct {
	...
	Commands *InlineObject2 `json:"commands,omitempty"`
...
// SetCommands gets a reference to the given InlineObject2 and assigns it to the Commands field.
...
func (o *InlineObject17) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varInlineObject17)
