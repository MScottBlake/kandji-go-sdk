...
// checks if the VulnerabilitiesListVulnerabilities200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VulnerabilitiesListVulnerabilities200Response{}
...
type _VulnerabilitiesListVulnerabilities200Response VulnerabilitiesListVulnerabilities200Response
...
func (o *VulnerabilitiesListVulnerabilities200Response) UnmarshalJSON(data []byte) (err error) {
	varVulnerabilitiesListVulnerabilities200Response := _VulnerabilitiesListVulnerabilities200Response{}

	err = json.Unmarshal(data, &varVulnerabilitiesListVulnerabilities200Response)

	if err != nil {
		return err
	}

	*o = VulnerabilitiesListVulnerabilities200Response(varVulnerabilitiesListVulnerabilities200Response)
...
type NullableVulnerabilitiesListVulnerabilities200Response struct {
	value *VulnerabilitiesListVulnerabilities200Response
	isSet bool
}

func (v NullableVulnerabilitiesListVulnerabilities200Response) Get() *VulnerabilitiesListVulnerabilities200Response {
	return v.value
}

func (v *NullableVulnerabilitiesListVulnerabilities200Response) Set(val *VulnerabilitiesListVulnerabilities200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableVulnerabilitiesListVulnerabilities200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableVulnerabilitiesListVulnerabilities200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVulnerabilitiesListVulnerabilities200Response(val *VulnerabilitiesListVulnerabilities200Response) *NullableVulnerabilitiesListVulnerabilities200Response {
	return &NullableVulnerabilitiesListVulnerabilities200Response{value: val, isSet: true}
}

func (v NullableVulnerabilitiesListVulnerabilities200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVulnerabilitiesListVulnerabilities200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
