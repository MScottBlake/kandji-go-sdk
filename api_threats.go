...
type ApiThreatsGetThreatDetailsRequest struct {
	ctx context.Context
...
func (r ApiThreatsGetThreatDetailsRequest) Classification(classification string) ApiThreatsGetThreatDetailsRequest {
...
func (r ApiThreatsGetThreatDetailsRequest) DateRange(dateRange string) ApiThreatsGetThreatDetailsRequest {
	r.dateRange = &dateRange
	return r
}

// 
func (r ApiThreatsGetThreatDetailsRequest) DeviceId(deviceId string) ApiThreatsGetThreatDetailsRequest {
	r.deviceId = &deviceId
	return r
}
...
func (r ApiThreatsGetThreatDetailsRequest) Status(status string) ApiThreatsGetThreatDetailsRequest {
	r.status = &status
	return r
}
...
func (r ApiThreatsGetThreatDetailsRequest) SortBy(sortBy string) ApiThreatsGetThreatDetailsRequest {
	r.sortBy = &sortBy
	return r
}
...
func (r ApiThreatsGetThreatDetailsRequest) Term(term string) ApiThreatsGetThreatDetailsRequest {
	r.term = &term
	return r
}
...
func (r ApiThreatsGetThreatDetailsRequest) Limit(limit string) ApiThreatsGetThreatDetailsRequest {
	r.limit = &limit
	return r
}

// Specify the starting record to return
func (r ApiThreatsGetThreatDetailsRequest) Offset(offset string) ApiThreatsGetThreatDetailsRequest {
	r.offset = &offset
	return r
}

func (r ApiThreatsGetThreatDetailsRequest) Execute() (map[string]interface{}, *http.Response, error) {
	return r.ApiService.ThreatsGetThreatDetailsExecute(r)
}

/*
ThreatsGetThreatDetails Get Threat Details

Get threat details.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiThreatsGetThreatDetailsRequest
*/
func (a *ThreatsAPIService) ThreatsGetThreatDetails(ctx context.Context) ApiThreatsGetThreatDetailsRequest {
	return ApiThreatsGetThreatDetailsRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *ThreatsAPIService) ThreatsGetThreatDetailsExecute(r ApiThreatsGetThreatDetailsRequest) (map[string]interface{}, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ThreatsAPIService.ThreatsGetThreatDetails")
	if err != nil {
