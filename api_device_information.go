...
type DeviceInformationAPI interface {
	...
	*/
	...
	GetDeviceExecute(r ApiGetDeviceRequest) (*InlineObject8, *http.Response, error)
	...
	*/
	...
	GetDeviceActivityExecute(r ApiGetDeviceActivityRequest) (*InlineObject12, *http.Response, error)
...
<p>For iPhone and iPad, the preinstalled Apple apps are not reported.</p>
	...
	*/
	...
	GetDeviceAppsExecute(r ApiGetDeviceAppsRequest) (*InlineObject13, *http.Response, error)
	...
	*/
	...
	GetDeviceDetailsExecute(r ApiGetDeviceDetailsRequest) (*InlineObject10, *http.Response, error)
...
<td>Configuration profile installed</td>
	...
	*/
	...
	GetDeviceLibraryItemsExecute(r ApiGetDeviceLibraryItemsRequest) (*InlineObject14, *http.Response, error)
...
<p><strong>Note</strong>: Lost Mode is is only available for iOS and iPadOS. For more information, please see this <a href=&quot;https://support.kandji.io/a/solutions/articles/72000573873&quot;>Kandji support artilcle</a>.</p>
	...
	*/
	...
	GetDeviceLostModeDetailsExecute(r ApiGetDeviceLostModeDetailsRequest) (*InlineObject11, *http.Response, error)
...
<td>Muted alert</td>
	...
	*/
	...
	GetDeviceParametersExecute(r ApiGetDeviceParametersRequest) (*InlineObject15, *http.Response, error)
...
<td>Muted alert</td>
	...
	*/
	...
	GetDeviceStatusExecute(r ApiGetDeviceStatusRequest) (*InlineObject16, *http.Response, error)
...
<pre class=&quot;click-to-expand-wrapper is-snippet-wrapper&quot;><code class=&quot;language-json&quot;>{
	...
	*/
	...
	UpdateDeviceExecute(r ApiUpdateDeviceRequest) (*InlineObject9, *http.Response, error)
}
...
func (r ApiGetDeviceRequest) Execute() (*InlineObject8, *http.Response, error) {
...
// Execute executes the request
//  @return InlineObject8
func (a *DeviceInformationAPIService) GetDeviceExecute(r ApiGetDeviceRequest) (*InlineObject8, *http.Response, error) {
	var (
...
func (r ApiGetDeviceActivityRequest) Execute() (*InlineObject12, *http.Response, error) {
...
// Execute executes the request
//  @return InlineObject12
func (a *DeviceInformationAPIService) GetDeviceActivityExecute(r ApiGetDeviceActivityRequest) (*InlineObject12, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *InlineObject12
	)
...
func (r ApiGetDeviceAppsRequest) Execute() (*InlineObject13, *http.Response, error) {
...
// Execute executes the request
//  @return InlineObject13
func (a *DeviceInformationAPIService) GetDeviceAppsExecute(r ApiGetDeviceAppsRequest) (*InlineObject13, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *InlineObject13
	)
...
func (r ApiGetDeviceDetailsRequest) Execute() (*InlineObject10, *http.Response, error) {
...
// Execute executes the request
//  @return InlineObject10
func (a *DeviceInformationAPIService) GetDeviceDetailsExecute(r ApiGetDeviceDetailsRequest) (*InlineObject10, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *InlineObject10
	)
...
func (r ApiGetDeviceLibraryItemsRequest) Execute() (*InlineObject14, *http.Response, error) {
...
// Execute executes the request
//  @return InlineObject14
func (a *DeviceInformationAPIService) GetDeviceLibraryItemsExecute(r ApiGetDeviceLibraryItemsRequest) (*InlineObject14, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *InlineObject14
	)
...
func (r ApiGetDeviceLostModeDetailsRequest) Execute() (*InlineObject11, *http.Response, error) {
...
// Execute executes the request
//  @return InlineObject11
func (a *DeviceInformationAPIService) GetDeviceLostModeDetailsExecute(r ApiGetDeviceLostModeDetailsRequest) (*InlineObject11, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r ApiGetDeviceParametersRequest) Execute() (*InlineObject15, *http.Response, error) {
...
// Execute executes the request
//  @return InlineObject15
func (a *DeviceInformationAPIService) GetDeviceParametersExecute(r ApiGetDeviceParametersRequest) (*InlineObject15, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r ApiGetDeviceStatusRequest) Execute() (*InlineObject16, *http.Response, error) {
...
// Execute executes the request
//  @return InlineObject16
func (a *DeviceInformationAPIService) GetDeviceStatusExecute(r ApiGetDeviceStatusRequest) (*InlineObject16, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r ApiUpdateDeviceRequest) Execute() (*InlineObject9, *http.Response, error) {
...
// Execute executes the request
//  @return InlineObject9
func (a *DeviceInformationAPIService) UpdateDeviceExecute(r ApiUpdateDeviceRequest) (*InlineObject9, *http.Response, error) {
	var (
