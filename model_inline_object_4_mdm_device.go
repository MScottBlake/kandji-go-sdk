...
// checks if the InlineObject4MdmDevice type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &InlineObject4MdmDevice{}

// InlineObject4MdmDevice struct for InlineObject4MdmDevice
type InlineObject4MdmDevice struct {
...
type _InlineObject4MdmDevice InlineObject4MdmDevice
...
func (o *InlineObject4MdmDevice) GetEnrollmentStatus() int32 {
...
// and a boolean to check if the value has been set.
func (o *InlineObject4MdmDevice) GetIsMissingOk() (*int32, bool) {
	if o == nil || IsNil(o.IsMissing) {
		return nil, false
	}
...
func (o InlineObject4MdmDevice) MarshalJSON() ([]byte, error) {
...
func (o InlineObject4MdmDevice) ToMap() (map[string]interface{}, error) {
...
func (o *InlineObject4MdmDevice) UnmarshalJSON(data []byte) (err error) {
	varInlineObject4MdmDevice := _InlineObject4MdmDevice{}

	err = json.Unmarshal(data, &varInlineObject4MdmDevice)

	if err != nil {
		return err
	}

	*o = InlineObject4MdmDevice(varInlineObject4MdmDevice)
...
type NullableInlineObject4MdmDevice struct {
	value *InlineObject4MdmDevice
	isSet bool
}

func (v NullableInlineObject4MdmDevice) Get() *InlineObject4MdmDevice {
	return v.value
}

func (v *NullableInlineObject4MdmDevice) Set(val *InlineObject4MdmDevice) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject4MdmDevice) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject4MdmDevice) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject4MdmDevice(val *InlineObject4MdmDevice) *NullableInlineObject4MdmDevice {
	return &NullableInlineObject4MdmDevice{value: val, isSet: true}
}

func (v NullableInlineObject4MdmDevice) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject4MdmDevice) UnmarshalJSON(src []byte) error {
	v.isSet = true
