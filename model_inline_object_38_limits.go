...
// checks if the InlineObject38Limits type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &InlineObject38Limits{}

// InlineObject38Limits struct for InlineObject38Limits
type InlineObject38Limits struct {
	PlanType *string `json:"plan_type,omitempty"`
	MaxDevices *int32 `json:"max_devices,omitempty"`
	MaxDevicesPerPlatform *InlineObject38LimitsMaxDevicesPerPlatform `json:"max_devices_per_platform,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _InlineObject38Limits InlineObject38Limits
...
func (o *InlineObject38Limits) GetMaxDevicesPerPlatform() InlineObject38LimitsMaxDevicesPerPlatform {
	if o == nil || IsNil(o.MaxDevicesPerPlatform) {
		var ret InlineObject38LimitsMaxDevicesPerPlatform
		return ret
	}
...
// SetMaxDevicesPerPlatform gets a reference to the given InlineObject38LimitsMaxDevicesPerPlatform and assigns it to the MaxDevicesPerPlatform field.
...
func (o InlineObject38Limits) MarshalJSON() ([]byte, error) {
...
func (o InlineObject38Limits) ToMap() (map[string]interface{}, error) {
...
func (o *InlineObject38Limits) UnmarshalJSON(data []byte) (err error) {
	varInlineObject38Limits := _InlineObject38Limits{}

	err = json.Unmarshal(data, &varInlineObject38Limits)

	if err != nil {
		return err
	}

	*o = InlineObject38Limits(varInlineObject38Limits)
...
type NullableInlineObject38Limits struct {
	value *InlineObject38Limits
	isSet bool
}

func (v NullableInlineObject38Limits) Get() *InlineObject38Limits {
	return v.value
}

func (v *NullableInlineObject38Limits) Set(val *InlineObject38Limits) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject38Limits) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject38Limits) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject38Limits(val *InlineObject38Limits) *NullableInlineObject38Limits {
	return &NullableInlineObject38Limits{value: val, isSet: true}
}

func (v NullableInlineObject38Limits) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject38Limits) UnmarshalJSON(src []byte) error {
	v.isSet = true
