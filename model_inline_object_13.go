...
type _InlineObject13 InlineObject13
...
func (o *InlineObject13) UnmarshalJSON(data []byte) (err error) {
	varInlineObject13 := _InlineObject13{}

	err = json.Unmarshal(data, &varInlineObject13)

	if err != nil {
		return err
	}

	*o = InlineObject13(varInlineObject13)
