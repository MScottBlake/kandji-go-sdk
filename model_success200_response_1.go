...
// checks if the Success200Response1 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &Success200Response1{}

// Success200Response1 struct for Success200Response1
type Success200Response1 struct {
...
type _Success200Response1 Success200Response1
...
func (o Success200Response1) MarshalJSON() ([]byte, error) {
...
func (o Success200Response1) ToMap() (map[string]interface{}, error) {
...
func (o *Success200Response1) UnmarshalJSON(data []byte) (err error) {
	varSuccess200Response1 := _Success200Response1{}

	err = json.Unmarshal(data, &varSuccess200Response1)

	if err != nil {
		return err
	}

	*o = Success200Response1(varSuccess200Response1)
...
type NullableSuccess200Response1 struct {
	value *Success200Response1
	isSet bool
}

func (v NullableSuccess200Response1) Get() *Success200Response1 {
	return v.value
}

func (v *NullableSuccess200Response1) Set(val *Success200Response1) {
	v.value = val
	v.isSet = true
}

func (v NullableSuccess200Response1) IsSet() bool {
	return v.isSet
}

func (v *NullableSuccess200Response1) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSuccess200Response1(val *Success200Response1) *NullableSuccess200Response1 {
	return &NullableSuccess200Response1{value: val, isSet: true}
}

func (v NullableSuccess200Response1) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSuccess200Response1) UnmarshalJSON(src []byte) error {
	v.isSet = true
