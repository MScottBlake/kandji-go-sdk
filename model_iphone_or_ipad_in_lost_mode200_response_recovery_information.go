...
// checks if the IphoneOrIpadInLostMode200ResponseRecoveryInformation type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IphoneOrIpadInLostMode200ResponseRecoveryInformation{}

// IphoneOrIpadInLostMode200ResponseRecoveryInformation struct for IphoneOrIpadInLostMode200ResponseRecoveryInformation
type IphoneOrIpadInLostMode200ResponseRecoveryInformation struct {
...
type _IphoneOrIpadInLostMode200ResponseRecoveryInformation IphoneOrIpadInLostMode200ResponseRecoveryInformation
...
func NewIphoneOrIpadInLostMode200ResponseRecoveryInformation() *IphoneOrIpadInLostMode200ResponseRecoveryInformation {
	this := IphoneOrIpadInLostMode200ResponseRecoveryInformation{}
	return &this
}
...
func (o IphoneOrIpadInLostMode200ResponseRecoveryInformation) MarshalJSON() ([]byte, error) {
...
func (o IphoneOrIpadInLostMode200ResponseRecoveryInformation) ToMap() (map[string]interface{}, error) {
...
func (o *IphoneOrIpadInLostMode200ResponseRecoveryInformation) UnmarshalJSON(data []byte) (err error) {
	varIphoneOrIpadInLostMode200ResponseRecoveryInformation := _IphoneOrIpadInLostMode200ResponseRecoveryInformation{}

	err = json.Unmarshal(data, &varIphoneOrIpadInLostMode200ResponseRecoveryInformation)

	if err != nil {
		return err
	}

	*o = IphoneOrIpadInLostMode200ResponseRecoveryInformation(varIphoneOrIpadInLostMode200ResponseRecoveryInformation)
...
type NullableIphoneOrIpadInLostMode200ResponseRecoveryInformation struct {
	value *IphoneOrIpadInLostMode200ResponseRecoveryInformation
	isSet bool
}

func (v NullableIphoneOrIpadInLostMode200ResponseRecoveryInformation) Get() *IphoneOrIpadInLostMode200ResponseRecoveryInformation {
	return v.value
}

func (v *NullableIphoneOrIpadInLostMode200ResponseRecoveryInformation) Set(val *IphoneOrIpadInLostMode200ResponseRecoveryInformation) {
	v.value = val
	v.isSet = true
}

func (v NullableIphoneOrIpadInLostMode200ResponseRecoveryInformation) IsSet() bool {
	return v.isSet
}

func (v *NullableIphoneOrIpadInLostMode200ResponseRecoveryInformation) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIphoneOrIpadInLostMode200ResponseRecoveryInformation(val *IphoneOrIpadInLostMode200ResponseRecoveryInformation) *NullableIphoneOrIpadInLostMode200ResponseRecoveryInformation {
	return &NullableIphoneOrIpadInLostMode200ResponseRecoveryInformation{value: val, isSet: true}
}

func (v NullableIphoneOrIpadInLostMode200ResponseRecoveryInformation) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIphoneOrIpadInLostMode200ResponseRecoveryInformation) UnmarshalJSON(src []byte) error {
	v.isSet = true
