...
type InlineObject8 struct {
	...
	User *InlineObject8User `json:"user,omitempty"`
...
// SetUser gets a reference to the given InlineObject8User and assigns it to the User field.
