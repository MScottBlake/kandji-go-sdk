...
// checks if the InlineObject27 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &InlineObject27{}
...
type _InlineObject27 InlineObject27
...
func (o *InlineObject27) HasSignedUrl() bool {
	if o != nil && !IsNil(o.SignedUrl) {
		return true
	}
...
func (o InlineObject27) ToMap() (map[string]interface{}, error) {
...
func (o *InlineObject27) UnmarshalJSON(data []byte) (err error) {
	varInlineObject27 := _InlineObject27{}

	err = json.Unmarshal(data, &varInlineObject27)

	if err != nil {
		return err
	}

	*o = InlineObject27(varInlineObject27)
