...
// and a boolean to check if the value has been set.
func (o *InlineObject5) GetParamsOk() (map[string]interface{}, bool) {
	if o == nil || IsNil(o.Params) {
...
func (o *InlineObject5) SetType(v string) {
	o.Type = &v
}
...
func (o *InlineObject5) UnmarshalJSON(data []byte) (err error) {
	varInlineObject5 := _InlineObject5{}

	err = json.Unmarshal(data, &varInlineObject5)
