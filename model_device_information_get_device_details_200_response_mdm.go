...
// checks if the DeviceInformationGetDeviceDetails200ResponseMdm type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DeviceInformationGetDeviceDetails200ResponseMdm{}
...
type _DeviceInformationGetDeviceDetails200ResponseMdm DeviceInformationGetDeviceDetails200ResponseMdm
...
func (o *DeviceInformationGetDeviceDetails200ResponseMdm) UnmarshalJSON(data []byte) (err error) {
	varDeviceInformationGetDeviceDetails200ResponseMdm := _DeviceInformationGetDeviceDetails200ResponseMdm{}

	err = json.Unmarshal(data, &varDeviceInformationGetDeviceDetails200ResponseMdm)

	if err != nil {
		return err
	}

	*o = DeviceInformationGetDeviceDetails200ResponseMdm(varDeviceInformationGetDeviceDetails200ResponseMdm)
...
type NullableDeviceInformationGetDeviceDetails200ResponseMdm struct {
	value *DeviceInformationGetDeviceDetails200ResponseMdm
	isSet bool
}

func (v NullableDeviceInformationGetDeviceDetails200ResponseMdm) Get() *DeviceInformationGetDeviceDetails200ResponseMdm {
	return v.value
}

func (v *NullableDeviceInformationGetDeviceDetails200ResponseMdm) Set(val *DeviceInformationGetDeviceDetails200ResponseMdm) {
	v.value = val
	v.isSet = true
}

func (v NullableDeviceInformationGetDeviceDetails200ResponseMdm) IsSet() bool {
	return v.isSet
}

func (v *NullableDeviceInformationGetDeviceDetails200ResponseMdm) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDeviceInformationGetDeviceDetails200ResponseMdm(val *DeviceInformationGetDeviceDetails200ResponseMdm) *NullableDeviceInformationGetDeviceDetails200ResponseMdm {
	return &NullableDeviceInformationGetDeviceDetails200ResponseMdm{value: val, isSet: true}
}

func (v NullableDeviceInformationGetDeviceDetails200ResponseMdm) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDeviceInformationGetDeviceDetails200ResponseMdm) UnmarshalJSON(src []byte) error {
	v.isSet = true
