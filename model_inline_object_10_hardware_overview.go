...
// checks if the InlineObject10HardwareOverview type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &InlineObject10HardwareOverview{}

// InlineObject10HardwareOverview struct for InlineObject10HardwareOverview
type InlineObject10HardwareOverview struct {
...
type _InlineObject10HardwareOverview InlineObject10HardwareOverview
...
func NewInlineObject10HardwareOverview() *InlineObject10HardwareOverview {
	this := InlineObject10HardwareOverview{}
	return &this
}
...
func (o InlineObject10HardwareOverview) MarshalJSON() ([]byte, error) {
...
func (o InlineObject10HardwareOverview) ToMap() (map[string]interface{}, error) {
...
func (o *InlineObject10HardwareOverview) UnmarshalJSON(data []byte) (err error) {
	varInlineObject10HardwareOverview := _InlineObject10HardwareOverview{}

	err = json.Unmarshal(data, &varInlineObject10HardwareOverview)

	if err != nil {
		return err
	}

	*o = InlineObject10HardwareOverview(varInlineObject10HardwareOverview)
...
type NullableInlineObject10HardwareOverview struct {
	value *InlineObject10HardwareOverview
	isSet bool
}

func (v NullableInlineObject10HardwareOverview) Get() *InlineObject10HardwareOverview {
	return v.value
}

func (v *NullableInlineObject10HardwareOverview) Set(val *InlineObject10HardwareOverview) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject10HardwareOverview) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject10HardwareOverview) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject10HardwareOverview(val *InlineObject10HardwareOverview) *NullableInlineObject10HardwareOverview {
	return &NullableInlineObject10HardwareOverview{value: val, isSet: true}
}

func (v NullableInlineObject10HardwareOverview) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject10HardwareOverview) UnmarshalJSON(src []byte) error {
	v.isSet = true
