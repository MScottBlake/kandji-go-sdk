...
type SettingsAPI interface {
	...
	*/
	...
	LicensingExecute(r ApiLicensingRequest) (*InlineObject38, *http.Response, error)
}
...
func (r ApiLicensingRequest) Execute() (*InlineObject38, *http.Response, error) {
...
//  @return InlineObject38
func (a *SettingsAPIService) LicensingExecute(r ApiLicensingRequest) (*InlineObject38, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *InlineObject38
	)
