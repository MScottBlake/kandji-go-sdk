...
// checks if the InlineObject10ActivationLock type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &InlineObject10ActivationLock{}

// InlineObject10ActivationLock struct for InlineObject10ActivationLock
type InlineObject10ActivationLock struct {
...
type _InlineObject10ActivationLock InlineObject10ActivationLock
...
func NewInlineObject10ActivationLock() *InlineObject10ActivationLock {
	this := InlineObject10ActivationLock{}
	return &this
}
...
func (o InlineObject10ActivationLock) MarshalJSON() ([]byte, error) {
...
func (o InlineObject10ActivationLock) ToMap() (map[string]interface{}, error) {
...
func (o *InlineObject10ActivationLock) UnmarshalJSON(data []byte) (err error) {
	varInlineObject10ActivationLock := _InlineObject10ActivationLock{}

	err = json.Unmarshal(data, &varInlineObject10ActivationLock)

	if err != nil {
		return err
	}

	*o = InlineObject10ActivationLock(varInlineObject10ActivationLock)
...
type NullableInlineObject10ActivationLock struct {
	value *InlineObject10ActivationLock
	isSet bool
}

func (v NullableInlineObject10ActivationLock) Get() *InlineObject10ActivationLock {
	return v.value
}

func (v *NullableInlineObject10ActivationLock) Set(val *InlineObject10ActivationLock) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineObject10ActivationLock) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineObject10ActivationLock) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineObject10ActivationLock(val *InlineObject10ActivationLock) *NullableInlineObject10ActivationLock {
	return &NullableInlineObject10ActivationLock{value: val, isSet: true}
}

func (v NullableInlineObject10ActivationLock) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineObject10ActivationLock) UnmarshalJSON(src []byte) error {
	v.isSet = true
