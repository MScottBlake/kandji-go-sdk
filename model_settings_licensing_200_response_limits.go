...
// checks if the SettingsLicensing200ResponseLimits type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SettingsLicensing200ResponseLimits{}
...
type _SettingsLicensing200ResponseLimits SettingsLicensing200ResponseLimits
...
func (o *SettingsLicensing200ResponseLimits) GetMaxDevicesPerPlatform() SettingsLicensing200ResponseLimitsMaxDevicesPerPlatform {
	if o == nil || IsNil(o.MaxDevicesPerPlatform) {
		var ret SettingsLicensing200ResponseLimitsMaxDevicesPerPlatform
		return ret
	}
...
// SetMaxDevicesPerPlatform gets a reference to the given SettingsLicensing200ResponseLimitsMaxDevicesPerPlatform and assigns it to the MaxDevicesPerPlatform field.
...
func (o *SettingsLicensing200ResponseLimits) UnmarshalJSON(data []byte) (err error) {
	varSettingsLicensing200ResponseLimits := _SettingsLicensing200ResponseLimits{}

	err = json.Unmarshal(data, &varSettingsLicensing200ResponseLimits)

	if err != nil {
		return err
	}

	*o = SettingsLicensing200ResponseLimits(varSettingsLicensing200ResponseLimits)
...
type NullableSettingsLicensing200ResponseLimits struct {
	value *SettingsLicensing200ResponseLimits
	isSet bool
}

func (v NullableSettingsLicensing200ResponseLimits) Get() *SettingsLicensing200ResponseLimits {
	return v.value
}

func (v *NullableSettingsLicensing200ResponseLimits) Set(val *SettingsLicensing200ResponseLimits) {
	v.value = val
	v.isSet = true
}

func (v NullableSettingsLicensing200ResponseLimits) IsSet() bool {
	return v.isSet
}

func (v *NullableSettingsLicensing200ResponseLimits) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSettingsLicensing200ResponseLimits(val *SettingsLicensing200ResponseLimits) *NullableSettingsLicensing200ResponseLimits {
	return &NullableSettingsLicensing200ResponseLimits{value: val, isSet: true}
}

func (v NullableSettingsLicensing200ResponseLimits) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSettingsLicensing200ResponseLimits) UnmarshalJSON(src []byte) error {
	v.isSet = true
