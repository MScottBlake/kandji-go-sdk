...
// checks if the PrismApplicationFirewall200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PrismApplicationFirewall200Response{}

// PrismApplicationFirewall200Response struct for PrismApplicationFirewall200Response
type PrismApplicationFirewall200Response struct {
...
type _PrismApplicationFirewall200Response PrismApplicationFirewall200Response
...
func NewPrismApplicationFirewall200Response() *PrismApplicationFirewall200Response {
	this := PrismApplicationFirewall200Response{}
	return &this
}
...
func (o PrismApplicationFirewall200Response) MarshalJSON() ([]byte, error) {
...
func (o PrismApplicationFirewall200Response) ToMap() (map[string]interface{}, error) {
...
func (o *PrismApplicationFirewall200Response) UnmarshalJSON(data []byte) (err error) {
	varPrismApplicationFirewall200Response := _PrismApplicationFirewall200Response{}

	err = json.Unmarshal(data, &varPrismApplicationFirewall200Response)

	if err != nil {
		return err
	}

	*o = PrismApplicationFirewall200Response(varPrismApplicationFirewall200Response)
...
type NullablePrismApplicationFirewall200Response struct {
	value *PrismApplicationFirewall200Response
	isSet bool
}

func (v NullablePrismApplicationFirewall200Response) Get() *PrismApplicationFirewall200Response {
	return v.value
}

func (v *NullablePrismApplicationFirewall200Response) Set(val *PrismApplicationFirewall200Response) {
	v.value = val
	v.isSet = true
}

func (v NullablePrismApplicationFirewall200Response) IsSet() bool {
	return v.isSet
}

func (v *NullablePrismApplicationFirewall200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePrismApplicationFirewall200Response(val *PrismApplicationFirewall200Response) *NullablePrismApplicationFirewall200Response {
	return &NullablePrismApplicationFirewall200Response{value: val, isSet: true}
}

func (v NullablePrismApplicationFirewall200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePrismApplicationFirewall200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
