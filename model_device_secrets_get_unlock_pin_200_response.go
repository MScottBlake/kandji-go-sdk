...
// checks if the DeviceSecretsGetUnlockPin200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DeviceSecretsGetUnlockPin200Response{}

// DeviceSecretsGetUnlockPin200Response struct for DeviceSecretsGetUnlockPin200Response
type DeviceSecretsGetUnlockPin200Response struct {
	Pin *string `json:"pin,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _DeviceSecretsGetUnlockPin200Response DeviceSecretsGetUnlockPin200Response
...
func NewDeviceSecretsGetUnlockPin200Response() *DeviceSecretsGetUnlockPin200Response {
	this := DeviceSecretsGetUnlockPin200Response{}
	return &this
}
...
func (o DeviceSecretsGetUnlockPin200Response) MarshalJSON() ([]byte, error) {
...
func (o DeviceSecretsGetUnlockPin200Response) ToMap() (map[string]interface{}, error) {
...
func (o *DeviceSecretsGetUnlockPin200Response) UnmarshalJSON(data []byte) (err error) {
	varDeviceSecretsGetUnlockPin200Response := _DeviceSecretsGetUnlockPin200Response{}

	err = json.Unmarshal(data, &varDeviceSecretsGetUnlockPin200Response)

	if err != nil {
		return err
	}

	*o = DeviceSecretsGetUnlockPin200Response(varDeviceSecretsGetUnlockPin200Response)
...
type NullableDeviceSecretsGetUnlockPin200Response struct {
	value *DeviceSecretsGetUnlockPin200Response
	isSet bool
}

func (v NullableDeviceSecretsGetUnlockPin200Response) Get() *DeviceSecretsGetUnlockPin200Response {
	return v.value
}

func (v *NullableDeviceSecretsGetUnlockPin200Response) Set(val *DeviceSecretsGetUnlockPin200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableDeviceSecretsGetUnlockPin200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableDeviceSecretsGetUnlockPin200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDeviceSecretsGetUnlockPin200Response(val *DeviceSecretsGetUnlockPin200Response) *NullableDeviceSecretsGetUnlockPin200Response {
	return &NullableDeviceSecretsGetUnlockPin200Response{value: val, isSet: true}
}

func (v NullableDeviceSecretsGetUnlockPin200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDeviceSecretsGetUnlockPin200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
