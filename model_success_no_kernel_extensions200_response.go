...
// checks if the SuccessNoKernelExtensions200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SuccessNoKernelExtensions200Response{}

// SuccessNoKernelExtensions200Response struct for SuccessNoKernelExtensions200Response
type SuccessNoKernelExtensions200Response struct {
...
type _SuccessNoKernelExtensions200Response SuccessNoKernelExtensions200Response
...
func NewSuccessNoKernelExtensions200Response() *SuccessNoKernelExtensions200Response {
	this := SuccessNoKernelExtensions200Response{}
	return &this
}
...
func (o SuccessNoKernelExtensions200Response) MarshalJSON() ([]byte, error) {
...
func (o SuccessNoKernelExtensions200Response) ToMap() (map[string]interface{}, error) {
...
func (o *SuccessNoKernelExtensions200Response) UnmarshalJSON(data []byte) (err error) {
	varSuccessNoKernelExtensions200Response := _SuccessNoKernelExtensions200Response{}

	err = json.Unmarshal(data, &varSuccessNoKernelExtensions200Response)

	if err != nil {
		return err
	}

	*o = SuccessNoKernelExtensions200Response(varSuccessNoKernelExtensions200Response)
...
type NullableSuccessNoKernelExtensions200Response struct {
	value *SuccessNoKernelExtensions200Response
	isSet bool
}

func (v NullableSuccessNoKernelExtensions200Response) Get() *SuccessNoKernelExtensions200Response {
	return v.value
}

func (v *NullableSuccessNoKernelExtensions200Response) Set(val *SuccessNoKernelExtensions200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableSuccessNoKernelExtensions200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableSuccessNoKernelExtensions200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSuccessNoKernelExtensions200Response(val *SuccessNoKernelExtensions200Response) *NullableSuccessNoKernelExtensions200Response {
	return &NullableSuccessNoKernelExtensions200Response{value: val, isSet: true}
}

func (v NullableSuccessNoKernelExtensions200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSuccessNoKernelExtensions200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
