...
// checks if the DeviceInformationGetDeviceDetails200ResponseLostMode type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DeviceInformationGetDeviceDetails200ResponseLostMode{}
...
type _DeviceInformationGetDeviceDetails200ResponseLostMode DeviceInformationGetDeviceDetails200ResponseLostMode
...
func (o DeviceInformationGetDeviceDetails200ResponseLostMode) MarshalJSON() ([]byte, error) {
...
func (o *DeviceInformationGetDeviceDetails200ResponseLostMode) UnmarshalJSON(data []byte) (err error) {
	varDeviceInformationGetDeviceDetails200ResponseLostMode := _DeviceInformationGetDeviceDetails200ResponseLostMode{}

	err = json.Unmarshal(data, &varDeviceInformationGetDeviceDetails200ResponseLostMode)

	if err != nil {
		return err
	}

	*o = DeviceInformationGetDeviceDetails200ResponseLostMode(varDeviceInformationGetDeviceDetails200ResponseLostMode)
...
type NullableDeviceInformationGetDeviceDetails200ResponseLostMode struct {
	value *DeviceInformationGetDeviceDetails200ResponseLostMode
	isSet bool
}

func (v NullableDeviceInformationGetDeviceDetails200ResponseLostMode) Get() *DeviceInformationGetDeviceDetails200ResponseLostMode {
	return v.value
}

func (v *NullableDeviceInformationGetDeviceDetails200ResponseLostMode) Set(val *DeviceInformationGetDeviceDetails200ResponseLostMode) {
	v.value = val
	v.isSet = true
}

func (v NullableDeviceInformationGetDeviceDetails200ResponseLostMode) IsSet() bool {
	return v.isSet
}

func (v *NullableDeviceInformationGetDeviceDetails200ResponseLostMode) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDeviceInformationGetDeviceDetails200ResponseLostMode(val *DeviceInformationGetDeviceDetails200ResponseLostMode) *NullableDeviceInformationGetDeviceDetails200ResponseLostMode {
	return &NullableDeviceInformationGetDeviceDetails200ResponseLostMode{value: val, isSet: true}
}

func (v NullableDeviceInformationGetDeviceDetails200ResponseLostMode) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDeviceInformationGetDeviceDetails200ResponseLostMode) UnmarshalJSON(src []byte) error {
	v.isSet = true
