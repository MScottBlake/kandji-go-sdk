...
// checks if the DeviceInformationGetDeviceDetails200ResponseKandjiAgent type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DeviceInformationGetDeviceDetails200ResponseKandjiAgent{}
...
type _DeviceInformationGetDeviceDetails200ResponseKandjiAgent DeviceInformationGetDeviceDetails200ResponseKandjiAgent
...
func NewDeviceInformationGetDeviceDetails200ResponseKandjiAgent() *DeviceInformationGetDeviceDetails200ResponseKandjiAgent {
	this := DeviceInformationGetDeviceDetails200ResponseKandjiAgent{}
	return &this
}
...
func (o DeviceInformationGetDeviceDetails200ResponseKandjiAgent) ToMap() (map[string]interface{}, error) {
...
func (o *DeviceInformationGetDeviceDetails200ResponseKandjiAgent) UnmarshalJSON(data []byte) (err error) {
	varDeviceInformationGetDeviceDetails200ResponseKandjiAgent := _DeviceInformationGetDeviceDetails200ResponseKandjiAgent{}

	err = json.Unmarshal(data, &varDeviceInformationGetDeviceDetails200ResponseKandjiAgent)

	if err != nil {
		return err
	}

	*o = DeviceInformationGetDeviceDetails200ResponseKandjiAgent(varDeviceInformationGetDeviceDetails200ResponseKandjiAgent)
...
type NullableDeviceInformationGetDeviceDetails200ResponseKandjiAgent struct {
	value *DeviceInformationGetDeviceDetails200ResponseKandjiAgent
	isSet bool
}

func (v NullableDeviceInformationGetDeviceDetails200ResponseKandjiAgent) Get() *DeviceInformationGetDeviceDetails200ResponseKandjiAgent {
	return v.value
}

func (v *NullableDeviceInformationGetDeviceDetails200ResponseKandjiAgent) Set(val *DeviceInformationGetDeviceDetails200ResponseKandjiAgent) {
	v.value = val
	v.isSet = true
}

func (v NullableDeviceInformationGetDeviceDetails200ResponseKandjiAgent) IsSet() bool {
	return v.isSet
}

func (v *NullableDeviceInformationGetDeviceDetails200ResponseKandjiAgent) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDeviceInformationGetDeviceDetails200ResponseKandjiAgent(val *DeviceInformationGetDeviceDetails200ResponseKandjiAgent) *NullableDeviceInformationGetDeviceDetails200ResponseKandjiAgent {
	return &NullableDeviceInformationGetDeviceDetails200ResponseKandjiAgent{value: val, isSet: true}
}

func (v NullableDeviceInformationGetDeviceDetails200ResponseKandjiAgent) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDeviceInformationGetDeviceDetails200ResponseKandjiAgent) UnmarshalJSON(src []byte) error {
	v.isSet = true
