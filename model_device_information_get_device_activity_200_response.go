...
// checks if the DeviceInformationGetDeviceActivity200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DeviceInformationGetDeviceActivity200Response{}
...
type _DeviceInformationGetDeviceActivity200Response DeviceInformationGetDeviceActivity200Response
...
func (o *DeviceInformationGetDeviceActivity200Response) UnmarshalJSON(data []byte) (err error) {
	varDeviceInformationGetDeviceActivity200Response := _DeviceInformationGetDeviceActivity200Response{}

	err = json.Unmarshal(data, &varDeviceInformationGetDeviceActivity200Response)

	if err != nil {
		return err
	}

	*o = DeviceInformationGetDeviceActivity200Response(varDeviceInformationGetDeviceActivity200Response)
...
type NullableDeviceInformationGetDeviceActivity200Response struct {
	value *DeviceInformationGetDeviceActivity200Response
	isSet bool
}

func (v NullableDeviceInformationGetDeviceActivity200Response) Get() *DeviceInformationGetDeviceActivity200Response {
	return v.value
}

func (v *NullableDeviceInformationGetDeviceActivity200Response) Set(val *DeviceInformationGetDeviceActivity200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableDeviceInformationGetDeviceActivity200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableDeviceInformationGetDeviceActivity200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDeviceInformationGetDeviceActivity200Response(val *DeviceInformationGetDeviceActivity200Response) *NullableDeviceInformationGetDeviceActivity200Response {
	return &NullableDeviceInformationGetDeviceActivity200Response{value: val, isSet: true}
}

func (v NullableDeviceInformationGetDeviceActivity200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDeviceInformationGetDeviceActivity200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
