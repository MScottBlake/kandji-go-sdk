...
// checks if the DeviceInformationGetDeviceLostModeDetails200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DeviceInformationGetDeviceLostModeDetails200Response{}

// DeviceInformationGetDeviceLostModeDetails200Response struct for DeviceInformationGetDeviceLostModeDetails200Response
type DeviceInformationGetDeviceLostModeDetails200Response struct {
	DeviceId *string `json:"device_id,omitempty"`
	LostMode *DeviceInformationGetDeviceLostModeDetails200ResponseLostMode `json:"lost_mode,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _DeviceInformationGetDeviceLostModeDetails200Response DeviceInformationGetDeviceLostModeDetails200Response
...
func NewDeviceInformationGetDeviceLostModeDetails200Response() *DeviceInformationGetDeviceLostModeDetails200Response {
	this := DeviceInformationGetDeviceLostModeDetails200Response{}
	return &this
}
...
func (o *DeviceInformationGetDeviceLostModeDetails200Response) GetLostMode() DeviceInformationGetDeviceLostModeDetails200ResponseLostMode {
	if o == nil || IsNil(o.LostMode) {
		var ret DeviceInformationGetDeviceLostModeDetails200ResponseLostMode
		return ret
	}
	return *o.LostMode
}
...
// SetLostMode gets a reference to the given DeviceInformationGetDeviceLostModeDetails200ResponseLostMode and assigns it to the LostMode field.
...
func (o DeviceInformationGetDeviceLostModeDetails200Response) MarshalJSON() ([]byte, error) {
...
func (o DeviceInformationGetDeviceLostModeDetails200Response) ToMap() (map[string]interface{}, error) {
...
func (o *DeviceInformationGetDeviceLostModeDetails200Response) UnmarshalJSON(data []byte) (err error) {
	varDeviceInformationGetDeviceLostModeDetails200Response := _DeviceInformationGetDeviceLostModeDetails200Response{}

	err = json.Unmarshal(data, &varDeviceInformationGetDeviceLostModeDetails200Response)

	if err != nil {
		return err
	}

	*o = DeviceInformationGetDeviceLostModeDetails200Response(varDeviceInformationGetDeviceLostModeDetails200Response)
...
type NullableDeviceInformationGetDeviceLostModeDetails200Response struct {
	value *DeviceInformationGetDeviceLostModeDetails200Response
	isSet bool
}

func (v NullableDeviceInformationGetDeviceLostModeDetails200Response) Get() *DeviceInformationGetDeviceLostModeDetails200Response {
	return v.value
}

func (v *NullableDeviceInformationGetDeviceLostModeDetails200Response) Set(val *DeviceInformationGetDeviceLostModeDetails200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableDeviceInformationGetDeviceLostModeDetails200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableDeviceInformationGetDeviceLostModeDetails200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDeviceInformationGetDeviceLostModeDetails200Response(val *DeviceInformationGetDeviceLostModeDetails200Response) *NullableDeviceInformationGetDeviceLostModeDetails200Response {
	return &NullableDeviceInformationGetDeviceLostModeDetails200Response{value: val, isSet: true}
}

func (v NullableDeviceInformationGetDeviceLostModeDetails200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDeviceInformationGetDeviceLostModeDetails200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
