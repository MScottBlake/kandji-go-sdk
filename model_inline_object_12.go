...
type InlineObject12 struct {
	...
	Activity *InlineObject2 `json:"activity,omitempty"`
...
// SetActivity gets a reference to the given InlineObject2 and assigns it to the Activity field.
...
func (o *InlineObject12) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varInlineObject12)
