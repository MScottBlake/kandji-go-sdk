...
// checks if the ClearAllTags200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ClearAllTags200Response{}

// ClearAllTags200Response struct for ClearAllTags200Response
type ClearAllTags200Response struct {
...
type _ClearAllTags200Response ClearAllTags200Response
...
func (o *ClearAllTags200Response) HasPlatform() bool {
	if o != nil && !IsNil(o.Platform) {
		return true
	}
...
func (o *ClearAllTags200Response) GetAgentVersion() string {
...
// and a boolean to check if the value has been set.
func (o *ClearAllTags200Response) GetLastEnrollmentOk() (*string, bool) {
	if o == nil || IsNil(o.LastEnrollment) {
		return nil, false
	}
...
func (o ClearAllTags200Response) MarshalJSON() ([]byte, error) {
...
func (o ClearAllTags200Response) ToMap() (map[string]interface{}, error) {
...
func (o *ClearAllTags200Response) UnmarshalJSON(data []byte) (err error) {
	varClearAllTags200Response := _ClearAllTags200Response{}

	err = json.Unmarshal(data, &varClearAllTags200Response)

	if err != nil {
		return err
	}

	*o = ClearAllTags200Response(varClearAllTags200Response)
...
type NullableClearAllTags200Response struct {
	value *ClearAllTags200Response
	isSet bool
}

func (v NullableClearAllTags200Response) Get() *ClearAllTags200Response {
	return v.value
}

func (v *NullableClearAllTags200Response) Set(val *ClearAllTags200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableClearAllTags200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableClearAllTags200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableClearAllTags200Response(val *ClearAllTags200Response) *NullableClearAllTags200Response {
	return &NullableClearAllTags200Response{value: val, isSet: true}
}

func (v NullableClearAllTags200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableClearAllTags200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
