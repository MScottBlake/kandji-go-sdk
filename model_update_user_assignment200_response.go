...
// checks if the UpdateUserAssignment200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UpdateUserAssignment200Response{}

// UpdateUserAssignment200Response struct for UpdateUserAssignment200Response
type UpdateUserAssignment200Response struct {
	BlueprintId *string `json:"blueprint_id,omitempty"`
	MdmDevice *Success200Response1MdmDevice `json:"mdm_device,omitempty"`
	UserId *string `json:"user_id,omitempty"`
	DepAccount *Success200Response1DepAccount `json:"dep_account,omitempty"`
...
type _UpdateUserAssignment200Response UpdateUserAssignment200Response
...
func NewUpdateUserAssignment200Response() *UpdateUserAssignment200Response {
	this := UpdateUserAssignment200Response{}
	return &this
}
...
func (o *UpdateUserAssignment200Response) GetMdmDevice() Success200Response1MdmDevice {
	if o == nil || IsNil(o.MdmDevice) {
		var ret Success200Response1MdmDevice
		return ret
	}
	return *o.MdmDevice
}
...
// SetMdmDevice gets a reference to the given Success200Response1MdmDevice and assigns it to the MdmDevice field.
...
func (o *UpdateUserAssignment200Response) GetDepAccount() Success200Response1DepAccount {
	if o == nil || IsNil(o.DepAccount) {
		var ret Success200Response1DepAccount
		return ret
	}
	return *o.DepAccount
}
...
// SetDepAccount gets a reference to the given Success200Response1DepAccount and assigns it to the DepAccount field.
...
func (o UpdateUserAssignment200Response) MarshalJSON() ([]byte, error) {
...
func (o UpdateUserAssignment200Response) ToMap() (map[string]interface{}, error) {
...
func (o *UpdateUserAssignment200Response) UnmarshalJSON(data []byte) (err error) {
	varUpdateUserAssignment200Response := _UpdateUserAssignment200Response{}

	err = json.Unmarshal(data, &varUpdateUserAssignment200Response)

	if err != nil {
		return err
	}

	*o = UpdateUserAssignment200Response(varUpdateUserAssignment200Response)
...
type NullableUpdateUserAssignment200Response struct {
	value *UpdateUserAssignment200Response
	isSet bool
}

func (v NullableUpdateUserAssignment200Response) Get() *UpdateUserAssignment200Response {
	return v.value
}

func (v *NullableUpdateUserAssignment200Response) Set(val *UpdateUserAssignment200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableUpdateUserAssignment200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableUpdateUserAssignment200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUpdateUserAssignment200Response(val *UpdateUserAssignment200Response) *NullableUpdateUserAssignment200Response {
	return &NullableUpdateUserAssignment200Response{value: val, isSet: true}
}

func (v NullableUpdateUserAssignment200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUpdateUserAssignment200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
